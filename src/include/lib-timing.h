...
/* macro per effettuare un test singolo usando il metodo basato sui clock cycles
 */
...
/* macro per effettuare un test singolo usando il metodo timestamp */
...
/* macro per il testing iterato per un numero fissato di run usando il metodo
 * timestamp */
#define perform_timestamp_sampling(STATS, VECTOR, NUM_SAMPLES, UNIT, CODE,     \
                                   CLEAN)                                      \
    {                                                                          \
        assert(STATS != NULL);                                                 \
...
/* macro per il testing iterato per un numero fissato di run usando il metodo
 * basato sui clock cycles */
#define perform_clock_cycles_sampling(STATS, VECTOR, NUM_SAMPLES, UNIT, CODE,  \
                                      CLEAN)                                   \
    {                                                                          \
        assert(STATS != NULL);                                                 \
        assert(NUM_SAMPLES > 0);                                               \
...
/* macro per il testing iterato per un periodo prefisatto usando il metodo
 * timestamp */
#define perform_timestamp_sampling_period(STATS, PERIOD, MAX_SAMPLES, UNIT,    \
                                          CODE, CLEAN)                         \
    {                                                                          \
        assert(STATS != NULL);                                                 \
        assert(PERIOD >= 0);                                                   \
...
/* macro per il testing iterato per un periodo prefisatto usando il metodo
 * basato sui clock cycles */
#define perform_clock_cycles_sampling_period(STATS, PERIOD, MAX_SAMPLES, UNIT, \
                                             CODE, CLEAN)                      \
    {                                                                          \
        assert(STATS != NULL);                                                 \
        assert(PERIOD >= 0);                                                   \
